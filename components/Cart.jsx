...
const Cart = () => {
  ...
  const {totalPrice,totalQuanities,cartItems,setshowCart,toggleCartItemQty,onRemove} = useStateContext();
  
  //Payment function
  const handleCheckOut = async ()=>{
     const stripe = await getStripe();
     //we can create a req. in frontend -> that is specaility of NEXTJS
    ...
    <div className='cart-wrapper' ref={cartRef}>
       <div className='cart-container'>
          <button type="button" className='cart-heading' onClick={()=>setshowCart(false)}>
            ...
            <span className='cart-num-items'>({totalQuanities} items)</span>
          </button>
